...
/**
  * A factory for a ts3clients object
  * @param {function} callback The callback.
  * @return {ts3clients} theObject.
  */
function create(callback) {
    return new ts3clients(callback);
}

/**
  * The TS3 Clients tree and information
  * @constructor
  * @this {ts3client}
  * @param {function} callback The callback.
  */
function ts3clients(callback) {
    ...
    /**
      ...
      * @param {object} object the object that results of execute('clientlist', {parameter: ['-away', '-voice', '-times', '-groups', '-info', '-uid', '-icon', '-country']}.
      * @param {function} callback The callback.
      */
    this.actualizeCommonInfo = function(object, callback) {
